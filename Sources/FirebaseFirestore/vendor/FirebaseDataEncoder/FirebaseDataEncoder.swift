...
extension __JSONDecoder {
  ...
  fileprivate func unbox(_ value: Any, as type: Bool.Type) throws -> Bool? {
    ...
    if let number = value as? NSNumber {
      ...
      // FIXME: This has been overriden to check boolValue
  ...
  fileprivate func getNumber(_ value: Any, as type: Any.Type) throws -> NSNumber {
    ...
    guard let number = val as? NSNumber, number !== NSNumber(true), number !== NSNumber(false) else {
  ...
  fileprivate func unbox(_ value: Any, as type: Float.Type) throws -> Float? {
    ...
    let val = rcValNumberAdaptor(value)
    if let number = val as? NSNumber, number !== NSNumber(true), number !== NSNumber(false) {
